...
if st.session_state.new_tenant:
    ...
    with st.form("myform"):
        ...
        options = st.selectbox(
            "Select Okapi URL:",
            ("https://okapi.medad.com", "https://okapi-g42.medad.com", "https://okapi-qa.medadstg.com", "https://okapi-uae.ils.medad.com","https://darah-okapi.mynaseej.net", "https://okapi.medadstg.com","http://10.0.8.243/okapi"),
            key="okapi",
        )
...
if st.session_state.backup_ten:
